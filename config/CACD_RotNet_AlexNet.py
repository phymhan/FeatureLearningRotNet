...
networks = {}
exp_dir = './experiments/CACD_RotNet_AlexNet'
...
networks['model'] = {'def_file': 'architectures/AlexNet.py', 'pretrained': None, 'opt': net_opt,  'optim_params': net_optim_params, 'exp_dir': exp_dir}
