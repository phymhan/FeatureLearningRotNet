...
net_opt['nChannels']   = 64

config['out_feat_keys'] = ['layer5']

networks = {}
# feat_pretrained_file = './experiments/CACD_RotNet_ResNet18ConvAvg_f64/model_net_latest'
exp_dir = './experiments/CACD_RotNet_ResNet18ConvAvg_f64'
